    ...
    <div class="row">
       <div class="col-sm-12">
             <div class="box box-primary">
                ...
                <form action="{{url('/addrecipe')}}"  id="recipeForm" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- left part -->
                <div class="box-body">
                        <div class="col-sm-8">
                            <div class="form-group">
                                ...
                                <input type="text" id="recipe-name" value="{!! old('rcp_name') !!}"  name="rcp_name" class="form-control input-group-lg" >
                            ...
                            <div class="form-group">
                                <div class="box box-default">
                                    ...
                                    <div class="box-body pad">
                                        <textarea id="recipeDscp" name="rcp_dscp" class="form-control" rows="15" >{!! old('rcp_dscp') !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                @endif
                                <textarea name="rscp_ingts" id="" class="form-control" cols="" rows="10">{!! old('rscp_ingts') !!}</textarea>
                            </div>
                            <h4>Recipe Picture</h4>
                            @if ($errors->has('recipeThumb'))
                                <span class="help-block">
                                    <strong class="text-red">{{$errors->first('recipeThumb')}}</strong>
                                </span>
                            @endif
                            <div class="input-group image-preview">
                                ...
                                <span class="input-group-btn">
                                    ...
                                    <div class="btn btn-default image-preview-input">
                                        ...
                                        <input type="file" value="{!! old( 'recipeThumb' )!!}" accept="image/*" name="recipeThumb"/> <!-- rename it -->
                                 ...
                                 <div class="form-group">
                                    <h4>Quantity in Stock <span class="text-red">*</span></h4>
                                    <input type="number" required value="{!! old( 'qty_in_stock' ) !!}" name="qty_in_stock" class="form-control">
                                 </div>
                                 <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" name="rcp_cp" value="{!! old( 'rcp_cp' )!!}" class="form-control" >
                                </div>  
                                <div class="form-group">
                                    <h4>Category</h4>
